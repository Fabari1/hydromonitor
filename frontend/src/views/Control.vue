<template>
   <v-container justify="center" align="center" fluid>
      <v-row max-width="1200px" justify="center">
         <v-col align="center">
            <v-sheet class="rounded-t-lg mb-1" color="surface" elevation="0" max-width="800" width="100%">
                <v-card class="text-secondary" title="LED Controls" color="surface" subtitle="Recent Settings" variant="tonal" flat5>
            ...
            <v-sheet class="mb-1" color="surface" elevation="0" max-width="800" width="100%">
                <v-card class="pt-5" color="surface" variant="tonal"></v-card>
            </v-sheet>
            <v-sheet class="mb-1" justify="center" align="center" color="surface" elevation="0" max-width="800" width="100%">
                <v-card class="pt-5" color="surface" variant="tonal">
                    <v-slider class="pt-2 bg-surface" append-icon="mdi:mdi-led-on" density="compact" thumb-size="16" color="secondary" label="LED Nodes" direction="horizontal" min="0" max="7" step="1" show-ticks thumb-label="always" v-model="led.nodes" ></v-slider>
                </v-card>
            </v-sheet>
            <v-sheet class="mb-1 pa-2" justify="center" align="center" border="set" max-width="800" width="100%">
